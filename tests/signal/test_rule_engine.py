...
class TestRuleEngineLoading:
    ...
    def test_all_rules_have_required_fields(self) -> None:
        ...
        for rule in engine.rules:
            ...
            assert rule.signal_direction in (
                "bullish",
                "bearish",
                "neutral",
            ), f"Invalid direction '{rule.signal_direction}' in {rule.rule_id}"
            assert rule.signal_strength in (
                "strong",
                "moderate",
                "weak",
...
class TestThresholdEvaluation:
    ...
    def test_gt_not_triggered(
        self, engine: RuleEngine, sample_dxy_data_mid: MacroDataSchema
    ) -> None:
    ...
    def test_vix_elevated_triggered(
        self, engine: RuleEngine, sample_vix_data_high: MacroDataSchema
    ) -> None:
    ...
    def test_evaluation_contains_input_value(
        self, engine: RuleEngine, sample_dxy_data_high: MacroDataSchema
    ) -> None:
    ...
    def test_evaluation_contains_condition_str(
        self, engine: RuleEngine, sample_dxy_data_high: MacroDataSchema
    ) -> None:
