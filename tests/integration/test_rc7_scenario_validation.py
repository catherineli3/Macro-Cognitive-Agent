...
def validate_narrative(n: MacroNarrative, scenario_name: str):
    ...
    assert (
        isinstance(n.macro_story, str) and len(n.macro_story) > 0
    ), f"{scenario_name}: missing macro_story"
...
class TestFedMeetingScenarios:
    ...
    def test_fed_hawkish_hold(self, engine):
        ...
        hs = HypothesisSet(
            hypotheses=[
                hyp(
                    "Fed hawkish hold tightens liquidity, dollar strengthens.",
                    "Liquidity",
                    "bearish",
                    0.80,
                    3,
    ...
    def test_fed_dovish_pivot(self, engine):
        ...
        hs = HypothesisSet(
            hypotheses=[
                hyp(
                    "Fed dovish pivot eases financial conditions.",
                    "Liquidity",
                    "bullish",
                    0.75,
                    3,
    ...
    def test_fed_emergency_cut(self, engine):
        ...
        hs = HypothesisSet(
            hypotheses=[
                hyp(
                    "Emergency rate cut signals severe stress.", "Liquidity", "bearish", 0.85, 4, 0
                ),
...
class TestCPIDataScenarios:
    ...
    def test_cpi_above_expectations(self, engine):
        ...
        hs = HypothesisSet(
            hypotheses=[
                hyp(
                    "Inflation re-acceleration pressures Fed to maintain restrictive stance.",
                    "Inflation",
                    "bearish",
                    0.80,
                    3,
    ...
    def test_cpi_below_expectations(self, engine):
        ...
        hs = HypothesisSet(
            hypotheses=[
                hyp(
                    "Disinflation on track, supporting eventual rate cuts.",
                    "Inflation",
                    "bullish",
                    0.75,
                    3,
...
class TestNFPDataScenarios:
    ...
    def test_nfp_strong(self, engine):
        ...
        hs = HypothesisSet(
            hypotheses=[
                hyp(
                    "Strong labor market supports resilient growth.",
                    "Growth",
                    "bullish",
                    0.75,
                    3,
    ...
    def test_nfp_weak(self, engine):
        ...
        hs = HypothesisSet(
            hypotheses=[
                hyp(
                    "Labor market deterioration signals economic slowdown.",
                    "Growth",
                    "bearish",
                    0.80,
                    3,
...
class TestAIEarningsScenarios:
    ...
    def test_ai_capex_surge(self, engine):
        ...
        hs = HypothesisSet(
            hypotheses=[
                hyp(
                    "AI capex boom drives risk appetite and growth expectations.",
                    "Growth",
                    "bullish",
                    0.80,
                    3,
    ...
    def test_ai_earnings_miss(self, engine):
        ...
        hs = HypothesisSet(
            hypotheses=[
                hyp(
                    "AI earnings miss triggers risk reassessment.", "Credit", "bearish", 0.80, 3, 0
                ),
            ],
...
class TestGeopoliticalScenarios:
    ...
    def test_trade_war_escalation(self, engine):
        ...
        hs = HypothesisSet(
            hypotheses=[
                hyp(
                    "Trade war escalation tightens conditions and slows growth.",
                    "Growth",
                    "bearish",
                    0.75,
                    3,
                ...
                hyp(
                    "Dollar strength from safe-haven flows tightens liquidity.",
                    "Liquidity",
                    "bearish",
                    0.70,
                    2,
...
class TestYieldCurveScenarios:
    ...
    def test_yield_curve_steepening(self, engine):
        ...
        hs = HypothesisSet(
            hypotheses=[
                hyp(
                    "Curve steepening reflects reflation expectations.",
                    "Liquidity",
                    "neutral",
                    0.65,
                    2,
...
class TestDXYCombinationScenarios:
    ...
    def test_dxy_vix_divergence(self, engine):
        ...
        hs = HypothesisSet(
            hypotheses=[
                hyp(
                    "Dollar strength and low VIX create mixed macro picture.",
                    "Liquidity",
                    "bearish",
                    0.50,
                    2,
    ...
    def test_dxy_hyg_correlation_breakdown(self, engine):
        ...
        hs = HypothesisSet(
            hypotheses=[
                ...
                hyp(
                    "Risk appetite remains despite dollar strength.",
                    "Credit",
                    "bullish",
                    0.65,
                    2,
...
class TestCopperGoldScenarios:
    ...
    def test_copper_surge(self, engine):
        ...
        hs = HypothesisSet(
            hypotheses=[
                hyp(
                    "Industrial commodity strength signals global growth acceleration.",
                    "Growth",
                    "bullish",
                    0.80,
                    3,
    ...
    def test_gold_surge_vix_spike(self, engine):
        ...
        hs = HypothesisSet(
            hypotheses=[
                hyp(
                    "Extreme risk aversion — gold and VIX surging.",
                    "Risk_Appetite",
                    "bearish",
                    0.90,
                    3,
                ...
                hyp(
                    "Credit markets pricing in severe stress scenario.",
                    "Credit",
                    "bearish",
                    0.85,
                    3,
    ...
    def test_confidence_gradual_increase(self, engine):
        ...
        priors = [
            BeliefRecord(
                ...
                timestamp=datetime(2026, 7, i, tzinfo=UTC),
            )
...
class TestMixedSignalScenarios:
    ...
    def test_growth_up_inflation_up(self, engine):
        ...
        hs = HypothesisSet(
            hypotheses=[
                ...
                hyp(
                    "Inflation remains elevated despite Fed tightening.",
                    "Inflation",
                    "bearish",
                    0.75,
                    3,
    ...
    def test_growth_down_inflation_down(self, engine):
        ...
        hs = HypothesisSet(
            hypotheses=[
                hyp(
                    "Growth slowing with disinflation — stagflation risk.",
                    "Growth",
                    "bearish",
                    0.75,
                    3,
