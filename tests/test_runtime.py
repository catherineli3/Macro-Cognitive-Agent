...
from src.runtime import (
    ...
    OutcomeScheduler,
    ReportGenerator,
    PaperTrader, ReplayDay, ReplayStats,
)
...
Pred = namedtuple('Pred', ['prediction_id','direction','asset','confidence','horizon','transmission_channel'])
thesis = ResearchThesis(title='Test E', core_belief='X causes Y', transmission_chain=['A','B'],
                        evidence=['E1','E2'], invalidation_conditions=['C1'], confidence=0.65)
...
cr = CycleResult(
    cycle_id='test-1', cycle_number=1, status='completed',
...
cr.framework_selection = type('FWS', (), {
...
print(f'[PASS] ReportGenerator: saved to report')
...
result2 = runner.run_today(
    macro_data={
        'spx': 5250, 'prev_spx': 5200,
        'vix': 14, 'prev_vix': 15,
        'dxy': 103, 'prev_dxy': 104,
        'us10y': 4.1, 'prev_us10y': 4.2,
        'us2y': 3.7, 'prev_us2y': 3.8,
    },
    date_str='2026-07-19',
)
...
print(f'[PASS] PaperTrader replay successful')
