...
class EventScheduler:
    ...
    DEFAULT_SCHEDULES: dict[SourceType, SourceSchedule] = {
        ...
        SourceType.REUTERS: SourceSchedule(
            source=SourceType.REUTERS, source_name="Reuters",
            frequency=ScheduleFrequency.EVERY_MINUTE,
            priority=10, requires_immediate_processing=True,
        ),
        SourceType.BLOOMBERG: SourceSchedule(
            source=SourceType.BLOOMBERG, source_name="Bloomberg Terminal",
            frequency=ScheduleFrequency.EVERY_MINUTE,
            priority=10, requires_immediate_processing=True,
        ),
        ...
        SourceType.FED_SPEECH: SourceSchedule(
            source=SourceType.FED_SPEECH, source_name="Fed Speeches",
            frequency=ScheduleFrequency.EVERY_15_MINUTES,
            active_start_hour=13, active_end_hour=21,  # US business hours UTC
            priority=8,
        ),
        SourceType.ECB_SPEECH: SourceSchedule(
            source=SourceType.ECB_SPEECH, source_name="ECB Speeches",
            frequency=ScheduleFrequency.EVERY_15_MINUTES,
            active_start_hour=7, active_end_hour=17,  # European hours UTC
            priority=7,
        ),
        SourceType.BOJ_SPEECH: SourceSchedule(
            source=SourceType.BOJ_SPEECH, source_name="BOJ Speeches",
            frequency=ScheduleFrequency.EVERY_HOUR,
            active_start_hour=0, active_end_hour=8,  # Japan hours UTC
            priority=6,
        ),
        
        # Policy statements — event-driven
        SourceType.FOMC_STATEMENT: SourceSchedule(
            source=SourceType.FOMC_STATEMENT, source_name="FOMC Statements",
            frequency=ScheduleFrequency.ON_EVENT,
            priority=10, requires_immediate_processing=True,
        ),
        SourceType.FOMC_MINUTES: SourceSchedule(
            source=SourceType.FOMC_MINUTES, source_name="FOMC Minutes",
            frequency=ScheduleFrequency.ON_EVENT,
            priority=8,
        ),
        ...
        SourceType.BLS: SourceSchedule(
            source=SourceType.BLS, source_name="Bureau of Labor Statistics",
            frequency=ScheduleFrequency.ON_EVENT,
            priority=9, requires_immediate_processing=True,
        ),
        SourceType.BEA: SourceSchedule(
            source=SourceType.BEA, source_name="Bureau of Economic Analysis",
            frequency=ScheduleFrequency.ON_EVENT,
            priority=7,
        ),
        ...
        SourceType.ETF_FLOW: SourceSchedule(
            source=SourceType.ETF_FLOW, source_name="ETF Flow Monitor",
            frequency=ScheduleFrequency.EVERY_4_HOURS,
            priority=4,
        ),
        SourceType.CME_FEDWATCH: SourceSchedule(
            source=SourceType.CME_FEDWATCH, source_name="CME FedWatch",
            frequency=ScheduleFrequency.EVERY_HOUR,
            priority=6,
        ),
        SourceType.INSTITUTIONAL_13F: SourceSchedule(
            source=SourceType.INSTITUTIONAL_13F, source_name="13F Filings",
        ...
        SourceType.TREASURY: SourceSchedule(
            source=SourceType.TREASURY, source_name="US Treasury",
            frequency=ScheduleFrequency.EVERY_DAY,
            priority=5,
        ),
        ...
        SourceType.IMF: SourceSchedule(
            source=SourceType.IMF, source_name="IMF",
            frequency=ScheduleFrequency.EVERY_WEEK,
            priority=2,
        ),
        SourceType.BIS: SourceSchedule(
            source=SourceType.BIS, source_name="BIS",
            frequency=ScheduleFrequency.EVERY_WEEK,
            priority=2,
        ),
        SourceType.WORLD_BANK: SourceSchedule(
            source=SourceType.WORLD_BANK, source_name="World Bank",
            frequency=ScheduleFrequency.EVERY_WEEK,
            priority=1,
        ),
    }

    def __init__(self, custom_schedules: Optional[dict[SourceType, SourceSchedule]] = None):
    ...
    def get_due_sources(self, current_time: Optional[datetime] = None) -> list[SourceType]:
    ...
    def record_poll(self, source: SourceType, success: bool = True, 
                    poll_time: Optional[datetime] = None):
        """Record a completed poll attempt."""
        now = poll_time or datetime.now(timezone.utc)
    ...
    def add_release_event(self, source: SourceType, release_time: str,
                          description: str = ""):
...
KEY_US_RELEASES = {
    "CPI": {"source": SourceType.BLS, "time_et": "08:30", "frequency": "monthly",
            "importance": "critical"},
    "PPI": {"source": SourceType.BLS, "time_et": "08:30", "frequency": "monthly",
            "importance": "high"},
    "NFP": {"source": SourceType.BLS, "time_et": "08:30", "frequency": "monthly",
            "importance": "critical"},
    "Unemployment Rate": {"source": SourceType.BLS, "time_et": "08:30", "frequency": "monthly",
                          "importance": "high"},
    "GDP (Advance)": {"source": SourceType.BEA, "time_et": "08:30", "frequency": "quarterly",
                       "importance": "critical"},
    "PCE": {"source": SourceType.BEA, "time_et": "08:30", "frequency": "monthly",
            "importance": "high"},
    "Retail Sales": {"source": SourceType.BEA, "time_et": "08:30", "frequency": "monthly",
                     "importance": "high"},
    "ISM Manufacturing": {"source": SourceType.BLS, "time_et": "10:00", "frequency": "monthly",
                          "importance": "high"},
    "FOMC Decision": {"source": SourceType.FOMC_STATEMENT, "time_et": "14:00",
                      "frequency": "8x/year", "importance": "critical"},
    "FOMC Minutes": {"source": SourceType.FOMC_MINUTES, "time_et": "14:00",
                     "frequency": "8x/year", "importance": "medium"},
}

KEY_GLOBAL_RELEASES = {
    "ECB Decision": {"source": SourceType.ECB_SPEECH, "time_utc": "12:15",
                     "frequency": "8x/year", "importance": "critical"},
    "BOJ Decision": {"source": SourceType.BOJ_SPEECH, "time_utc": "03:00",
                     "frequency": "8x/year", "importance": "critical"},
    "China GDP": {"source": SourceType.PBOC, "time_utc": "02:00",
                  "frequency": "quarterly", "importance": "high"},
    "China CPI": {"source": SourceType.PBOC, "time_utc": "01:30",
                  "frequency": "monthly", "importance": "medium"},
}
