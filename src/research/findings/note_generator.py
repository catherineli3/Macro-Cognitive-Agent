...
Milestone B.5 (migrated): The "researcher upgrade" — instead of "BROKEN: credit→capex",
the agent produces:
...
Migration: src/transmission/research_note.py → src/research/findings/note_generator.py
"""
