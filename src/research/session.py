...
class SessionManager:
    ...
    def create_session(self, title: str, description: str = "",
                       tags: Optional[list[str]] = None) -> ResearchSession:
    ...
    def add_entry(self, session_id: str, phase: SessionPhase,
                  content: str, input_data: Optional[dict] = None,
                  output_data: Optional[dict] = None,
                  decisions: Optional[list[str]] = None,
                  questions: Optional[list[str]] = None,
                  insights: Optional[list[str]] = None) -> Optional[SessionEntry]:
    ...
    def add_hypothesis(self, session_id: str, hypothesis: str,
                       confidence: float = 0.5, evidence: Optional[list[str]] = None) -> bool:
    ...
    def add_counter_argument(self, session_id: str, argument: str,
    ...
    def add_prediction(self, session_id: str, prediction: str,
                       probability: float = 0.5,
                       invalidation_condition: str = "",
                       time_horizon: str = "") -> bool:
    ...
    def list_sessions(self, status: Optional[SessionStatus] = None) -> list[dict]:
    ...
    def export_session(self, session_id: str) -> Optional[dict]:
        ...
        return {
            ...
            "memo_versions": [
                {"version": mv["version"], "published_at": mv["published_at"],
                 "length": len(mv["memo"])} 
