...
from src.research.corpus.memo_segmenter import MemoSegmenter, MemoSection
...
class ArgumentExtractor:
    ...
    def extract_with_context(self, doc: ResearchDocument) -> list[tuple[CorpusCounterArgument, MemoSection]]:
    ...
    def _extract_from_text(
        ...
        for i, sentence in enumerate(sentences):
            if self._is_counterargument(sentence):
                ...
                counter.against_hypothesis = self._find_target_hypothesis(
                    sentences, i
                )

                # Evidence for the counter
                counter.evidence_for_counter = self._find_evidence(
                    sentences, i
                )
